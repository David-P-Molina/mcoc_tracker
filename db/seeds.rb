Klass.create(name: "Mutant",class_bonus: "Skill", class_weakness: "Tech", "Characters in the Mutant class possess the X-gene. At some point in their life, the gene surfaced, and a genetic mutation was born.")
Klass.create(name: "Skill",class_bonus: "Science", class_weakness: "Mutant", "Characters in the Skill class are trained fighters. These characters dont rely on special powers to win fights.")
Klass.create(name: "Science",class_bonus: "Mystic", class_weakness: "Skill", "Many characters in the Science class were genetically altered, often in freak accidents. However, some characters are instead unaltered but rely on science to fight.")
Klass.create(name: "Mystic",class_bonus: "Cosmic", class_weakness: "Science", "Characters in the Mystic class are associated in some way with mysticism or magic.")
Klass.create(name: "Cosmic",class_bonus: "Tech", class_weakness: "Mystic", "Characters in the Cosmic class are generally characters that come from space or other realms. However, some Cosmic characters were experimented on by species from outer space.")
Klass.create(name: "Tech",class_bonus: "Mutant", class_weakness: "Cosmic", "Many characters in the Tech class are androids. However, some Tech characters are simply connected in some way to technology.")
Klass.create(name: "Combined",class_bonus: "All", class_weakness: "None", "Combined Champions possess elements of at least two Classes.")
...
Champion.create(name: "Captain Marvel", release_date: "March 7, 2019", klass: "Cosmic")
...
Champion.create(name: "Daredevil (Hells Kitchen)", release_date: "November 19, 2015", klass: "Skill")
